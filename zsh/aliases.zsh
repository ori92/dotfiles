...
alias clip='xargs echo -n | wl-copy'                                            # Copy to clipboard shortened
alias copy='wl-copy'                                                            # Copy using clipboard 
alias paste='wl-paste'                                                          # Paste using clipboard
...
alias gpt='chatgpt'                                                             # ChatGPT shortened
alias h="head"
