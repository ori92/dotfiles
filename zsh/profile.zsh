...
# FZF
FZF_PREVIEW='[[ -d {} ]] && lsd --color=always -l --total-size --blocks=name,size {} ||
...
export FZF_DEFAULT_COMMAND='fd --color=always -H -E ".git" -E ".cache" -E "cache" -E ".nuget" -E "Brave-Browser" -E "CachedData" -E "Cache" -E "site-packages"  -E "icons" -E ".cargo" -E "node_modules" -E ".npm" -E ".vscode" -E ".rustup" -E "nvim/bundle" -E ".icons" -E ".dotnet"'
